...
set -Ux tide_bun_bg_color 'FBF0DF'
set -Ux tide_bun_color '14151A'
set -Ux tide_bun_icon '󰳓'
...
set -Ux tide_git_truncation_strategy
...
set -Ux tide_left_prompt_items 'vi_mode' 'pwd' 'git' 'newline'
...
set -Ux tide_os_bg_color '333333'
set -Ux tide_os_color 'D6D6D6'
set -Ux tide_os_icon ''
...
set -Ux tide_pwd_markers '.bzr' '.citc' '.git' '.hg' '.node-version' '.python-version' '.ruby-version' '.tool-versions' 'Makefile' 'Cargo.toml' 'composer.json' 'go.mod' 'package.json'
...
set -Ux tide_right_prompt_items 'status' 'cmd_duration' 'context' 'jobs' 'direnv' 'bun' 'node' 'python' 'rustc' 'java' 'php' 'pulumi' 'ruby' 'go' 'gcloud' 'kubectl' 'distrobox' 'toolbox' 'terraform' 'aws' 'nix_shell' 'crystal' 'elixir' 'zig' 'time'
